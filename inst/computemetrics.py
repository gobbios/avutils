...
def get_couple_files_original(ref_path, hyp_path=None, prefix=None):
...
def get_couple_files(ref_path, hyp_path):
    hyp_files = [hyp_path]
    ref_files = [ref_path]
...
def main():
    ...
    references_f, hypothesis_f = get_couple_files(args.reference, args.hypothesis)
